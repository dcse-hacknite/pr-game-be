...
client.connect({}, frame => {
    ...
    client.subscribe("/pr/events", payload => {

        let message_list = document.getElementById('message-list');
        let message = document.createElement('li');

        message.appendChild(document.createTextNode(JSON.parse(payload.body).event));
...
function sendMessage(){
    ...
    client.send('/app/connect', {}, JSON.stringify({event: message}));
